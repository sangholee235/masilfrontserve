<template>
  <b-container class="bv-example-row mt-3">
    ...
    <b-row class="mb-1">
      <b-col>
        <b-card
          :header-html="`<h3 class='mb-3'>${article.subject}</h3><div><h6>${article.userId}</div><div>${article.registerTime}</h6></div>`"
          class="mb-2 article"
          border-variant="dark"
          no-body
        >
    ...
    <b-row class="mb-1">
      ...
      <b-col class="text-right" v-if="userInfo && article.userId == userInfo.userId">
        <b-button variant="outline-dark" @click="moveModifyArticle" class="mr-2">수정</b-button>
    ...
    <b-row class="mt-3">
      <b-col>
        <div>
          <b-form-group id="input-memo" label="댓글" label-for="memo" description="">
            <b-card
              ...
              <div v-for="(memoItem, index) in memoList" :key="index">
                ...
                <b-row class="mb-2">
                  ...
                  <b-col cols="10" class="text-left">
                    <h6>{{ memoItem.comment }} &nbsp;({{ memoItem.memoTime }})</h6>
                  </b-col>
            ...
            <b-row class="mb-1" v-if="userInfo">
              ...
              <b-col cols="1" class="text-right">
                <b-button type="button" variant="dark" @click="writeMemo">입력</b-button>
              </b-col>
            </b-row>
          </b-form-group>
        </div>
